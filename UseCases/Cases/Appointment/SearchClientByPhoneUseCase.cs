...
public class SearchClientByPhoneUseCase
{
    ...
    public SearchClientByPhoneUseCase(
    ...
    public async Task<ClientCreateResponse> Run(SearchClientByPhoneRequest request)
    {
        //Patron Specification
        var specSearchClientByEmail = new FindSpecification<Client>
        {
            Criteria = s => s.VcPhone == request.VcPhone
        };
